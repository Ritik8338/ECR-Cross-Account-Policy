variable "container-image" {
    type = string
    default = "246618743249.dkr.ecr.us-west-2.amazonaws.com/sagemaker-scikit-learn:0.20.0-cpu-py3"
    description = "The container you are utilizing for your SageMaker Model"
}

variable "model-data" {
    type = string
    default = "s3://sagemaker-us-west-2-575773971780/sagemaker-scikit-learn-2023-08-01-07-55-41-383/output/model.tar.gz"
